                ...
                <div class="container">
                    ...
                    <div class="right-container">
                        <div class="well" id="data">
                            ...
                            <table class="table">
                                <tbody>
                                    <td class="script" style="text-align: center"><a class="link pricing" href="#">Link of ABS Tool</a></td>
                                </tbody>
                            </table>
                            <div class="headers">
                                Gallery
                            ...
                            <table class="table">
                                <tbody>
                                    <?php
                                        $images = Gallery::retreiveAllImagesByFlag(5);
                            ...
                            <table class="table">
                                <tbody>
                                    <?php
                                        $scripts = Script::retrieveScriptsByFlag(5);
